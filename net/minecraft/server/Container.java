...
public abstract class Container {
    ...
    public void a(ICrafting icrafting) {
        ...
        for (int i = 0; i < this.e.size(); ++i) {
            arraylist.add(((Slot) this.e.get(i)).a());
        }
    ...
    public void a() {
        for (int i = 0; i < this.e.size(); ++i) {
            ItemStack itemstack = ((Slot) this.e.get(i)).a();
        ...
        if (j == 0 || j == 1) {
            ...
            if (i == -999) {
                ...
                if (slot != null) {
                    ...
                    if (itemstack1 == null) {
                        if (itemstack2 != null && slot.b(itemstack2)) {

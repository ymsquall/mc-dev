...
public class EntitySlime extends EntityLiving implements IMonster {
    ...
    public EntitySlime(World world) {
        ...
        this.height = 0.0F;
        this.c = this.random.nextInt(20) + 10;
        this.e(i);
    }
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        this.e(nbttagcompound.e("Size") + 1);
    }
    ...
    public void b(EntityHuman entityhuman) {
        ...
        if (i > 1 && this.e(entityhuman) && (double) this.f(entityhuman) < 0.6D * (double) i && entityhuman.a((Entity) this, i)) {
    ...
    public boolean b() {
        ...
        return (this.m() == 1 || this.world.j > 0) && this.random.nextInt(10) == 0 && chunk.a(987234911L).nextInt(10) == 0 && this.locY < 16.0D;
    }

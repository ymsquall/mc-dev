...
public class EntityWolf extends EntityAnimal {
    ...
    protected void c_() {
        ...
        if (!this.e && !this.z() && this.y()) {
        ...
        } else if (this.d == null && !this.z() && !this.y() && this.world.k.nextInt(100) == 0) {
            ...
            if (!list.isEmpty()) {
                this.c((Entity) list.get(this.world.k.nextInt(list.size())));
            }
        }
    ...
    public void f_() {
        ...
        if (this.g_()) {
            ...
            if (this.h == 0.0F) {
                this.world.a(this, "mob.wolf.shake", this.i(), (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F);
            }
            ...
            if (this.h > 0.4F) {
                ...
                int i = (int) (MathHelper.a((this.h - 0.4F) * 3.1415927F) * 7.0F);
    ...
    private void b(Entity entity, float f) {
        PathEntity pathentity = this.world.a(this, entity, 16.0F);

        if (pathentity == null && f > 12.0F) {
            int i = MathHelper.b(entity.locX) - 2;
            int j = MathHelper.b(entity.locZ) - 2;
            int k = MathHelper.b(entity.boundingBox.b);

            for (int l = 0; l <= 4; ++l) {
                for (int i1 = 0; i1 <= 4; ++i1) {
                    if ((l < 1 || i1 < 1 || l > 3 || i1 > 3) && this.world.d(i + l, k - 1, j + i1) && !this.world.d(i + l, k, j + i1) && !this.world.d(i + l, k + 1, j + i1)) {
                        this.c((double) ((float) (i + l) + 0.5F), (double) k, (double) ((float) (j + i1) + 0.5F), this.yaw, this.pitch);
                        return;
                    }
                }
            }
    ...
    public boolean a(Entity entity, int i) {
        ...
        if (!super.a((Entity) entity, i)) {
            return false;
        } else {
            if (!this.y() && !this.x()) {
                if (entity instanceof EntityHuman) {
                    this.c(true);
                    this.d = (Entity) entity;
                }

                if (entity instanceof EntityArrow && ((EntityArrow) entity).b != null) {
                    entity = ((EntityArrow) entity).b;
                }
                ...
                if (entity instanceof EntityLiving) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (!entitywolf.y() && entitywolf.d == null) {
                            entitywolf.d = (Entity) entity;
                            if (entity instanceof EntityHuman) {
                                entitywolf.c(true);
                            }
                        }
